...
public class Waypoint_Modified : MonoBehaviour
{
	...
	void Update()
	{
		...
		occupied 	= Camera.main.transform.position == gameObject.transform.position;
	...
	public void Click()
	{
		...
		var component = Camera.main.GetComponent<Player>();
		component.cell = Cell;

		
		Camera.main.transform.parent.position = gameObject.transform.position;
    }
